      ...
      <main className="flex-1">
        <section className="max-w-3xl mx-auto px-6 pt-16 pb-12">
          ...
          <p className="text-muted text-lg mt-5 leading-relaxed">
            Відповіді на питання, які виникають у власників магазинів, кав'ярень і квіткових до і
            після підключення каси: фіскалізація, офлайн-режим, зміни, продажі в ефірі. Коротка
