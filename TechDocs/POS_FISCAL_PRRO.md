...
| **8в** | Реквизиты из Checkbox (організація, точка, ФН ПРРО, ставки) → кэш → шапка и полный фискальный блок нашего макета по п. 2 розділу II Положення № 13; секция «Реквізити ПРРО» в админке (read-only); первый чек — только онлайн | 🟡 план в [POS_FISCAL_OFFLINE.md](POS_FISCAL_OFFLINE.md) «Фаза 8в», 2026-09-12 |
