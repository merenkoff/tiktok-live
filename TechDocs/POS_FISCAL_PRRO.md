...
`api.checkbox.in.ua`. Осталось только то, что вне области v1 (фаза 8) —
`receipt_source='provider'`, полный офлайн-режим ПРРО.
...
либо начало фазы 8, если она понадобится раньше.
